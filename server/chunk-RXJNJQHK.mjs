...
`,_r=I`
  ...
  ${U}
`,fe=class e{constructor(n,t){this.environment=n;this.apollo=t;this.endpoint=`${this.environment.storeUrl}/api/${this.environment.apiVersion}/graphql.json`,this.headers=new Ze({"Content-Type":"application/json","X-Shopify-Storefront-Access-Token":this.environment.storeFrontToken})}endpoint;headers;createCart(n,t=1){return this.apollo.mutate({mutation:jr,variables:{input:{lines:[{merchandiseId:n,quantity:t}]}}}).pipe(g(r=>this.mapCartResponse(r,"cartCreate")))}addLine(n,t,r=1){return this.apollo.mutate({mutation:Tr,variables:{cartId:n,lines:[{merchandiseId:t,quantity:r}]}}).pipe(g(i=>this.mapCartResponse(i,"cartLinesAdd")))}updateLine(n,t,r){return this.apollo.mutate({mutation:Or,variables:{cartId:n,lines:[{id:t,quantity:r}]}}).pipe(g(i=>this.mapCartResponse(i,"cartLinesUpdate")))}removeLines(n,t){return this.apollo.mutate({mutation:xr,variables:{cartId:n,lineIds:t}}).pipe(g(r=>this.mapCartResponse(r,"cartLinesRemove")))}getCart(n){return this.apollo.query({query:_r,variables:{cartId:n}}).pipe(g(t=>this.mapCartObject(t.data?.cart)))}mapCartResponse(n,t){if(n?.errors?.length)throw new Error(n.errors.map(i=>i.message).join(", "));let r=n?.data?.[t];if(!r)throw new Error(`Missing ${t} response from Shopify.`);if(r.userErrors?.length)throw new Error(r.userErrors.map(i=>i.message).join(", "));return this.mapCartObject(r.cart)}mapCartObject(n){let t=this.mapCartLines(n?.lines);return{id:n?.id,checkoutUrl:n?.checkoutUrl,totalQuantity:t.reduce((r,i)=>r+i.quantity,0),lines:t}}mapCartLines(n){return(n?.edges||[]).map(r=>{let i=r?.node||{},o=i.merchandise||{},s=o.priceV2?.amount||"0.00",c=o.priceV2?.currencyCode||"",l=o.product?.title||o.title||"Product",C=Number.parseFloat(s)*i.quantity;return{id:i.id,merchandiseId:o.id,title:l,quantity:i.quantity,price:`${s} ${c}`,imageUrl:o.image?.url,subtotal:C}})}static \u0275fac=function(t){return new(t||e)(p(We),p(Je))};static \u0275prov=v({token:e,factory:e.\u0275fac,providedIn:"root"})};var Mr={dispatch:!0,functional:!1,useEffectsErrorHandler:!0},de="__@ngrx/effects_create__";function A(e,n={}){let t=n.functional?e:e(),r=a(a({},Mr),n);return Object.defineProperty(t,de,{value:r}),t}function wr(e){return Object.getOwnPropertyNames(e).filter(r=>e[r]&&e[r].hasOwnProperty(de)?e[r][de].hasOwnProperty("dispatch"):!1).map(r=>{let i=e[r][de];return a({propertyName:r},i)})}function Lr(e){return wr(e)}function Ft(e){return Object.getPrototypeOf(e)}function Dr(e){return!!e.constructor&&e.constructor.name!=="Object"&&e.constructor.name!=="Function"}function At(e){return typeof e=="function"}function Ur(e){return e.filter(At)}function $r(e,n,t){let r=Ft(e),o=!!r&&r.constructor.name!=="Object"?r.constructor.name:null,s=Lr(e).map(({propertyName:c,dispatch:l,useEffectsErrorHandler:C})=>{let u=typeof e[c]=="function"?e[c]():e[c],R=C?t(u,n):u;return l===!1?R.pipe(De()):R.pipe(Ne()).pipe(g($=>({effect:e[c],notification:$,propertyName:c,sourceName:o,sourceInstance:e})))});return pe(...s)}var kr=10;function bt(e,n,t=kr){return e.pipe(S(r=>(n&&n.handleError(r),t<=1?e:bt(e,n,t-1))))}var jt=(()=>{class e extends j{constructor(t){super(),t&&(this.source=t)}lift(t){let r=new e;return r.source=this,r.operator=t,r}static{this.\u0275fac=function(r){return new(r||e)(p(D))}}static{this.\u0275prov=v({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();function b(...e){return P(n=>e.some(t=>typeof t=="string"?t===n.type:t.type===n.type))}var Nr=new d("@ngrx/effects Effects Error Handler",{providedIn:"root",factory:()=>bt}),Pr="@ngrx/effects/init",Vr=h(Pr);function zr(e,n){if(e.notification.kind==="N"){let t=e.notification.value;!qr(t)&&n.handleError(new Error(`Effect ${Gr(e)} dispatched an invalid action: ${Hr(t)}`))}}function qr(e){return typeof e!="function"&&e&&e.type&&typeof e.type=="string"}function Gr({propertyName:e,sourceInstance:n,sourceName:t}){let r=typeof n[e]=="function";return!!t?`"${t}.${String(e)}${r?"()":""}"`:`"${String(e)}()"`}function Hr(e){try{return JSON.stringify(e)}catch{return e}}var Kr="ngrxOnIdentifyEffects";function Br(e){return Oe(e,Kr)}var Yr="ngrxOnRunEffects";function Qr(e){return Oe(e,Yr)}var Zr="ngrxOnInitEffects";function Jr(e){return Oe(e,Zr)}function Oe(e,n){return e&&n in e&&typeof e[n]=="function"}var Tt=(()=>{class e extends k{constructor(t,r){super(),this.errorHandler=t,this.effectsErrorHandler=r}addEffects(t){this.next(t)}toActions(){return this.pipe(me(t=>Dr(t)?Ft(t):t),le(t=>t.pipe(me(Wr))),le(t=>{let r=t.pipe(ke(o=>Xr(this.errorHandler,this.effectsErrorHandler)(o)),g(o=>(zr(o,this.errorHandler),o.notification)),P(o=>o.kind==="N"&&o.value!=null),Ue()),i=t.pipe(Le(1),P(Jr),g(o=>o.ngrxOnInitEffects()));return pe(r,i)}))}static{this.\u0275fac=function(r){return new(r||e)(p(Ge),p(Nr))}}static{this.\u0275prov=v({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();function Wr(e){return Br(e)?e.ngrxOnIdentifyEffects():""}function Xr(e,n){return t=>{let r=$r(t,e,n);return Qr(t)?t.ngrxOnRunEffects(r):r}}var en=(()=>{class e{get isStarted(){return!!this.effectsSubscription}constructor(t,r){this.effectSources=t,this.store=r,this.effectsSubscription=null}start(){this.effectsSubscription||(this.effectsSubscription=this.effectSources.toActions().subscribe(this.store))}ngOnDestroy(){this.effectsSubscription&&(this.effectsSubscription.unsubscribe(),this.effectsSubscription=null)}static{this.\u0275fac=function(r){return new(r||e)(p(Tt),p(F))}}static{this.\u0275prov=v({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();function Pn(...e){let n=e.flat(),t=Ur(n);return V([t,_(()=>{f(w),f(G,{optional:!0});let r=f(en),i=f(Tt),o=!r.isStarted;o&&r.start();for(let s of n){let c=At(s)?f(s):s;i.addEffects(c)}o&&f(F).dispatch(Vr())})])}var Ot=class e{actions$=f(jt);cartService=f(fe);createCart$=A(()=>this.actions$.pipe(b(Y),O(({variantId:n,quantity:t})=>this.cartService.createCart(n,t).pipe(he(r=>{r.id&&localStorage.setItem("cartId",r.id)}),g(r=>Q({cart:r})),S(r=>T(Z({error:r.message})))))));addLine$=A(()=>this.actions$.pipe(b(J),O(({cartId:n,variantId:t,quantity:r})=>this.cartService.addLine(n,t,r).pipe(g(i=>W({cart:i})),S(i=>T(X({error:i.message})))))));updateLine$=A(()=>this.actions$.pipe(b(ee),O(({cartId:n,lineId:t,quantity:r})=>this.cartService.updateLine(n,t,r).pipe(g(i=>te({cart:i})),S(i=>T(re({error:i.message})))))));removeLines$=A(()=>this.actions$.pipe(b(ne),O(({cartId:n,lineIds:t})=>this.cartService.removeLines(n,t).pipe(g(r=>ie({cart:r})),S(r=>T(oe({error:r.message})))))));getCart$=A(()=>this.actions$.pipe(b(se),O(({cartId:n})=>this.cartService.getCart(n).pipe(g(t=>ce({cart:t})),S(t=>T(ae({error:t.message})))))));clearCart$=A(()=>this.actions$.pipe(b(ue),he(()=>{localStorage.removeItem("cartId")})),{dispatch:!1});static \u0275fac=function(t){return new(t||e)};static \u0275prov=v({token:e,factory:e.\u0275fac})};export{F as a,nr as b,fn as c,dn as d,Y as e,J as f,ee as g,ne as h,se as i,ue as j,yn as k,Pn as l,fe as m,Ot as n};
